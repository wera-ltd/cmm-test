import{X as c,Y as d,ak as g,bw as m,bI as p,aQ as u,bJ as b,c as a,o as i,H as t,m as f,q as h,U as o,ag as w}from"./k5hUpmuK.js";var y=c`
    .p-inlinemessage {
        display: inline-flex;
        align-items: center;
...
`,v={root:function(s){var n=s.props,r=s.instance;return["p-inlinemessage p-component p-inlinemessage-"+n.severity,{"p-inlinemessage-icon-only":!r.$slots.default}]},icon:function(s){var n=s.props;return["p-inlinemessage-icon",n.icon]},text:"p-inlinemessage-text"},k=d.extend({name:"inlinemessage",style:y,classes:v}),x={name:"BaseInlineMessage",extends:g,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:k,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},$={name:"InlineMessage",extends:x,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var s=this;this.sticky||setTimeout(function(){s.visible=!1},this.life)},computed:{iconComponent:function(){return{info:b,success:u,warn:p,error:m}[this.severity]}}};function I(e,s,n,r,B,l){return i(),a("div",o({role:"alert","aria-live":"assertive","aria-atomic":"true",class:e.cx("root")},e.ptmi("root")),[t(e.$slots,"icon",{},function(){return[(i(),h(w(e.icon?"span":l.iconComponent),o({class:e.cx("icon")},e.ptm("icon")),null,16,["class"]))]}),e.$slots.default?(i(),a("div",o({key:0,class:e.cx("text")},e.ptm("text")),[t(e.$slots,"default")],16)):f("",!0)],16)}$.render=I;export{$ as default};
