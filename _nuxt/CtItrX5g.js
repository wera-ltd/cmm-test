import{S as m,T as l,af as n,bD as c,at as s,c as p,o as g,B as d,a as h,Q as t}from"./q01f3vzv.js";var u=m`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,b={root:"p-imagecompare",slider:"p-imagecompare-slider"},f=l.extend({name:"imagecompare",style:u,classes:b}),v={name:"BaseImageCompare",extends:n,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:f,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},w={name:"ImageCompare",extends:v,methods:{onSlide:function(a){var o=a.target.value,i=a.target.previousElementSibling;c(i,s("imagecompare.scope.x").name,"".concat(o,"%"))}}},y=["aria-labelledby","aria-label"];function z(e,a,o,i,k,r){return g(),p("div",t({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[d(e.$slots,"left"),d(e.$slots,"right"),h("input",t({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,y)}w.render=z;export{w as default};
