import{X as m,Y as l,ak as n,bK as c,ay as s,c as p,o as g,H as d,a as h,U as t}from"./DNgY89sE.js";var u=m`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,b={root:"p-imagecompare",slider:"p-imagecompare-slider"},v=l.extend({name:"imagecompare",style:u,classes:b}),f={name:"BaseImageCompare",extends:n,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:v,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},w={name:"ImageCompare",extends:f,methods:{onSlide:function(a){var o=a.target.value,i=a.target.previousElementSibling;c(i,s("imagecompare.scope.x").name,"".concat(o,"%"))}}},y=["aria-labelledby","aria-label"];function k(e,a,o,i,z,r){return g(),p("div",t({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[d(e.$slots,"left"),d(e.$slots,"right"),h("input",t({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,y)}w.render=k;export{w as default};
