import{X as m,Z as v,a0 as S,a4 as p,ac as d,ad as O,c as b,o as c,F as B,L,z as w,ah as A,w as V,D as K,a as T,T as y,t as D}from"./DDzVq1Yu.js";import I from"./DW-ilPAl.js";import{s as k}from"./DyDvQWn6.js";var R=`
    .p-selectbutton {
        display: inline-flex;
        user-select: none;
...
`,C={root:function(n){var t=n.props,l=n.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":t.fluid}]}},E=m.extend({name:"selectbutton",style:R,classes:C}),x={name:"BaseSelectButton",extends:k,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:E,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function z(e,n){var t=typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(!t){if(Array.isArray(e)||(t=h(e))||n){t&&(e=t);var l=0,s=function(){};return{s,n:function(){return l>=e.length?{done:!0}:{done:!1,value:e[l++]}},e:function(u){throw u},f:s}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
